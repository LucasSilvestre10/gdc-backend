...
export * from "./CustomExceptions.js";
...
export class InvalidObjectIdError extends ValidationError {
  constructor(fieldName: string = "ID") {
    super(
      `${fieldName} deve ser um ObjectId válido de 24 caracteres hexadecimais`,
      "INVALID_OBJECT_ID"
    );
  }
}
...
export class DocumentAlreadyExistsError extends ConflictError {
  constructor(documentType: string) {
    super(
      `Documento ${documentType} já foi enviado por este colaborador`,
